                                        ...
                                        <div class="card-block">
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input value="<?= $pecah['namapengguna'] ?>" type="text" required class="form-control" name="nama" placeholder="Nama">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                            ...
                                            // echo $_GET['id'];
                                            if (isset($_POST['ubah'])) {
                                                $koneksi->query("UPDATE pengguna SET email='$_POST[email]',namapengguna='$_POST[nama]', password='$_POST[password]' WHERE email='$emailadmin'") or die(mysqli_error($koneksi));
