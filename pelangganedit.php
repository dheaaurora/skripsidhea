                                        ...
                                        <div class="card-block">
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" value="<?= $pecah['namapelanggan'] ?>" name="nama" placeholder="Nama Pelanggan">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                            ...
                                            if (isset($_POST['tambah'])) {
                                                $koneksi->query("UPDATE pelanggan SET namapelanggan='$_POST[nama]',email='$_POST[email]', nohp='$_POST[nohp]', alamat='$_POST[alamat]' WHERE idpelanggan='$_GET[id]'") or die(mysqli_error($koneksi));
