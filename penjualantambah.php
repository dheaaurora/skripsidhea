                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Tambah Penjualan</h5>
                            </div>
                        </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="idpelanggan" class="form-control" required>
                                                            ...
                                                            <?php $ambilpelanggan = $koneksi->query("SELECT*FROM pelanggan"); ?>
                                                            <?php while ($pelanggan = $ambilpelanggan->fetch_assoc()) { ?>
...
if (isset($_POST['simpan'])) {
    ...
    foreach ($_POST['idproduk'] as $val) {
        ...
        $total = $_POST['total'][$i];
        $koneksi->query("INSERT INTO penjualan(idpelanggan,notajual,kodenota,idproduk,harga,jumlah,total,tanggalpenjualan,grandtotal,uangpembeli,kembalian,buktipembayaran)
    	VALUES ('$idpelanggan','$notajual','$kodenota','$idproduk','$harga','$jumlah','$total','$tanggalpenjualan','$grandtotal','$uangpembeli','$kembalian','$namafoto')") or die(mysqli_error($koneksi));
...
<script>
    ...
    $('#tabelform').on('change', '.idproduk', function() {
        var $select = $(this);
        var idproduk = $select.val();
