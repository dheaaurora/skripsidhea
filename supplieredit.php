                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Ubah Supplier</h5>
                            </div>
                        </div>
                                        ...
                                        <div class="card-block">
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" value="<?= $pecah['namasupplier'] ?>" name="nama" placeholder="Nama Supplier">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea required class="form-control" name="rekening" placeholder="Rekening"><?= $pecah['rekening'] ?></textarea>
                                                    </div>
                                                </div>
                                            ...
                                            if (isset($_POST['tambah'])) {
                                                $koneksi->query("UPDATE supplier SET namasupplier='$_POST[nama]',nohp='$_POST[nohp]', email='$_POST[email]', alamat='$_POST[alamat]', rekening='$_POST[rekening]' WHERE idsupplier='$_GET[id]'") or die(mysqli_error($koneksi));
                                                echo "<script> alert('Suplier Sudah Diupdate');</script>";
