                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="supplieredit.php?id=<?php echo $pecah['idsupplier']; ?>" class="btn btn-success m-1">Edit</a>
                                                    <a href="supplierhapus.php?id=<?php echo $pecah['idsupplier']; ?>" class="btn btn-danger m-1" onclick="return confirm('Yakin Mau di Hapus?')">Hapus</a>
                                                </td>
                                            </tr>
                                            <?php $nomor++; ?>
                                        <?php } ?>
