              ...
              <?php if ($_SESSION['admin']['level'] == 'Admin') { ?>
                ...
                <!-- <ul class="pcoded-item pcoded-left-item">
                  <li class="pcoded-hasmenu ">
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a href="returtambah.php" class="waves-effect waves-dark">
                          <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                          <span class="pcoded-mtext">Tambah Retur</span>
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                      <li class="">
                        <a href="returdaftar.php" class="waves-effect waves-dark">
                          <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                          <span class="pcoded-mtext">Daftar Retur</span>
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                    </ul>
