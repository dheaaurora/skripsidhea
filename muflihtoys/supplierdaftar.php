                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="supplieredit.php?id=<?php echo $pecah['idsupplier']; ?>" class="btn btn-success">Edit</a>
                                                    <a href="supplierhapus.php?id=<?php echo $pecah['idsupplier']; ?>" class="btn btn-danger" onclick="return confirm('Yakin Mau di Hapus?')">Hapus</a>
                                                </td>
                                            </tr>
                                            <?php $nomor++; ?>
                                        <?php } ?>
