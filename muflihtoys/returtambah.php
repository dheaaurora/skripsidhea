                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Tambah Retur</h5>
                            </div>
                        </div>
...
if (isset($_POST['simpan'])) {
    ...
    foreach ($_POST['namabarang'] as $val) {
        ...
        $total = $_POST['total'][$i];
        $koneksi->query("INSERT INTO retur(notabeli,namabarang,harga,jumlah,total,tanggalpembelian,grandtotal)
    ...
    echo "<script> alert('Retur Barang Berhasil Disimpan');</script>";
