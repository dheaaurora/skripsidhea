...
<div class="pcoded-content">
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Daftar Retur</h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="pcoded-inner-content">
                        ...
                        <div class="card-block table-border-style">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="table">
                                    ...
                                    <tbody>
                                        <?php $nomor = 1; ?>
                                        <?php $ambil = $koneksi->query("SELECT*FROM retur group by notabeli order by tanggalpembelian desc");
                                        $totalpengeluaran = 0;
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td width="40%">
                                                    <table style="width: 100%;">
                                                        ...
                                                        <?php
                                                            $ambildaftarbarang = $koneksi->query("SELECT*FROM retur where notabeli = '$pecah[notabeli]'");
                                                ...
                                                <td>
                                                    ...
                                                    <a href="returhapus.php?id=<?php echo $pecah['notabeli']; ?>" class="btn btn-danger mb-1" onclick="return confirm('Apakah anda yakin ingin menghapus data ini ?')">Hapus</a>
                                                </td>
                                            </tr>
                                            <?php
        ...
        if (isset($_POST['simpan'])) {
            ...
            $koneksi->query("UPDATE retur SET statuspembelian='$statuspembelian' WHERE notabeli='$notabeli'") or die(mysqli_error($koneksi));
            echo "<script> alert('Status Retur Berhasil Disimpan');</script>";
