                                        ...
                                        <div class="card-block">
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" value="<?= $pecah['nama'] ?>" name="nama" placeholder="Nama Supplier">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                            ...
                                            if (isset($_POST['tambah'])) {
                                                $koneksi->query("UPDATE supplier SET nama='$_POST[nama]',nohp='$_POST[nohp]', email='$_POST[email]', alamat='$_POST[alamat]', rekening='$_POST[rekening]' WHERE idsupplier='$_GET[id]'") or die(mysqli_error($koneksi));
