                                        ...
                                        <div class="card-block">
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="namapelanggan[]" class="form-control namapelanggan" required>
                                                            <option value="">Pilih Pelanggan</option>
                                                            <?php $ambil = $koneksi->query("SELECT*FROM pelanggan "); ?>
                                                            <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                                                                <option value="<?= $pecah['nama'] ?>"><?= $pecah['nama'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
...
if (isset($_POST['simpan'])) {
    ...
    foreach ($_POST['namabarang'] as $val) {
        ...
        $total = $_POST['total'][$i];
        $koneksi->query("INSERT INTO pembelian(notabeli,namabarang,harga,jumlah,total,tanggalpembelian,grandtotal,namapelanggan)
		VALUES ('$notabeli','$namabarang','$harga','$jumlah','$total','$tanggalpembelian','$grandtotal','$namapelanggan')") or die(mysqli_error($koneksi));
