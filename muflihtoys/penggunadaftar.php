                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td><?= $pecah['level'] ?></td>
                                                <td>
                                                    <a href="penggunaedit.php?id=<?php echo $pecah['idpengguna']; ?>" class="btn btn-success">Edit</a>
                                                    <a href="penggunahapus.php?id=<?php echo $pecah['idpengguna']; ?>" class="btn btn-danger" onclick="return confirm('Yakin Mau di Hapus?')">Hapus</a>
                                                </td>
                                            </tr>
                                            <?php $nomor++; ?>
                                        <?php } ?>
