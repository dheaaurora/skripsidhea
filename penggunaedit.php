                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select required class="form-control" name="level">
                                                            ...
                                                            <option <?php if ($pecah['level'] == 'Kasir') echo 'selected'; ?> value="Kasir">Kasir</option>
                                                            <option <?php if ($pecah['level'] == 'Gudang') echo 'selected'; ?> value="Gudang">Gudang</option>
                                                            <option <?php if ($pecah['level'] == 'Owner') echo 'selected'; ?> value="Owner">Owner</option>
                                                        </select>
                                                    </div>
                                                </div>
