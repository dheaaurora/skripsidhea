...
<head>
  ...
  <!-- Favicon icon -->
  <link rel="icon" href="foto/logobaru.png" type="image/x-icon">
  <!-- Google font-->
...
<body>
  ...
  } elseif ($_SESSION['admin']['level'] == 'Owner') {
  ...
  <div id="pcoded" class="pcoded">
    ...
    <div class="pcoded-container navbar-wrapper">
      <nav class="navbar header-navbar pcoded-header <?= $background ?>">
        <div class="navbar-wrapper">
          <div class="navbar-logo">
            ...
            <a href="index.php">
              <p style="font-size: 23px;text-align:left;padding-top:5%;">Muflih Toys</p>
            </a>
        ...
        <div class="pcoded-wrapper">
          <nav class="pcoded-navbar ">
            ...
            <div class="pcoded-inner-navbar main-menu">
              <div class="">
                <div class="main-menu-header">
                  ...
                  <div class="user-details">
                    <span id="more-details"><?= $_SESSION['admin']['level'] ?> Page</span>
                  </div>
                </div>
              </div>
              ...
              <?php if ($_SESSION['admin']['level'] == 'Admin') { ?>
                    ...
                    <ul class="pcoded-submenu">
                      <li class=" ">
                        <a href="tambahproduk.php" class="waves-effect waves-dark">
                          ...
                          <span class="pcoded-mtext">Tambah Produk</span>
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                      <li class=" ">
                        <a href="daftarproduk.php" class="waves-effect waves-dark">
                          <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                          <span class="pcoded-mtext">Persediaan Produk</span>
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                    </ul>
                ...
                <ul class="pcoded-item pcoded-left-item">
                  <li class="pcoded-hasmenu ">
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a href="pelanggantambah.php" class="waves-effect waves-dark">
                          <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                      ...
                      <li class="">
                        <a href="pelanggandaftar.php" class="waves-effect waves-dark">
                          <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                          <span class="pcoded-mtext">Daftar Pelanggan</span>
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                    </ul>
              ...
              <?php } ?>
              <?php if ($_SESSION['admin']['level'] == 'Owner') { ?>
                <ul class="pcoded-item pcoded-left-item">
                  <li class="pcoded-hasmenu">
                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                      <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i><b>BC</b></span>
                ...
                <ul class="pcoded-item pcoded-left-item">
                  <li class="pcoded-hasmenu ">
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a href="suppliertambah.php" class="waves-effect waves-dark">
                          <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                      ...
                      <li class="">
                        <a href="supplierdaftar.php" class="waves-effect waves-dark">
                          <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                          <span class="pcoded-mtext">Daftar Supplier</span>
                          <span class="pcoded-mcaret"></span>
                        </a>
                      </li>
                    </ul>
                ...
                <ul class="pcoded-item pcoded-left-item">
                  <li class="pcoded-hasmenu ">
                    ...
                    <ul class="pcoded-submenu">
                      <li class="">
                        <a href="penggunatambah.php" class="waves-effect waves-dark">
                          <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                      ...
                      <li class="">
                        <a href="penggunadaftar.php" class="waves-effect waves-dark">
                          <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
              ...
              if ($_SESSION['admin']['level'] == 'Gudang') { ?>
                <ul class="pcoded-item pcoded-left-item">
                  <li class="pcoded-hasmenu">
                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                      <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i><b>BC</b></span>
